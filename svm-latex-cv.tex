...
\usepackage{sectsty}
\sectionfont{\rmfamily\series\large\bf}
\subsectionfont{\rmfamily\mdseries\large\scshape}
...
% JAN - I Removed this, i was getting 2 page numbers a the bottom, a "1" and in bottom right, a "1/7". 
% This removed the 1/7 one. 
...
%\usepackage[scale=0.75, top=1.5cm, bottom = 1.5cm, left = 1.7cm, right = 1.7cm]{geometry} % Reduce document margins
